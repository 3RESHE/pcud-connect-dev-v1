        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <div class="relative">
                        ...
                        <!-- Dropdown Menu -->
                        <div id="userMenu"
                            class="hidden origin-top-right absolute right-0 mt-2 w-56 rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 z-50 transform transition-all duration-200"
                            ...
                            <div class="px-4 py-4 border-b border-gray-200">
                                <div class="flex items-center space-x-3">
                                    ...
                                    @else
                                        <div
                                            class="h-12 w-12 rounded-full bg-primary flex items-center justify-center flex-shrink-0">
                ...
                <div class="md:hidden flex items-center">
                    <button onclick="toggleMobileMenu()"
                        ...
                        <svg id="hamburgerIcon" class="block h-6 w-6" xmlns="http://www.w3.org/2000/svg"
            ...
            <div id="mobileMenu" class="md:hidden hidden transition-all duration-300 ease-in-out">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-gray-200 bg-white">
                    <a href="{{ route('alumni.dashboard') }}"
                        class="@if (request()->routeIs('alumni.dashboard')) text-primary bg-primary bg-opacity-10 @else text-gray-700 hover:text-primary hover:bg-gray-100 @endif block px-3 py-2 rounded-md text-base font-medium transition-colors duration-200">Dashboard</a>
                    <a href="{{ route('alumni.jobs.index') }}"
                    ...
                    <a href="{{ route('alumni.profile.show') }}"
                        class="@if (request()->routeIs('alumni.profile.*')) text-primary bg-primary bg-opacity-10 @else text-gray-700 hover:text-primary hover:bg-gray-100 @endif block px-3 py-2 rounded-md text-base font-medium transition-colors duration-200">Profile</a>
                </div>
                ...
                <div class="pt-4 pb-3 border-t border-gray-200">
                    <div class="flex items-center px-5">
                        <div class="flex-shrink-0">
                            ...
                            @else
                                <div
                                    class="h-10 w-10 rounded-full bg-primary flex items-center justify-center flex-shrink-0">
                                    <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z">
