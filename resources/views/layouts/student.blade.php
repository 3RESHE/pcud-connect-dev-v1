                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:ml-10 md:flex md:space-x-8">
                        <a href="{{ route('student.dashboard') }}"
                            class="@if (request()->routeIs('student.dashboard')) text-primary border-b-2 border-primary @else text-gray-700 hover:text-primary @endif px-1 pt-1 pb-4 text-sm font-medium transition-colors duration-200">
                            Dashboard
                        </a>
