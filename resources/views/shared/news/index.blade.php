    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex gap-3">
                        <select name="category"
                            ...
                            <option value="partnership_highlights"
                                {{ request('category') === 'partnership_highlights' ? 'selected' : '' }}>Partnership Highlights</option>
        ...
        <div class="mb-12">
            ...
            @if ($articles->count() > 0)
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    @if ($featured)
                        <a href="{{ route('news.show', $featured->id) }}" class="group cursor-pointer">
                            <div
                    ...
                    <div class="space-y-6">
                        @foreach ($articles->skip(1)->take(3) as $secondary)
                            <a href="{{ route('news.show', $secondary->id) }}" class="group cursor-pointer">
        ...
        <div class="mb-12">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('news.index') }}"
                    class="text-primary hover:text-blue-700 font-medium">View All →</a>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (searchInput) {
                searchInput.addEventListener('input', function(e) {
                    ...
                    const newsCards = document.querySelectorAll('#newsGrid > a');
