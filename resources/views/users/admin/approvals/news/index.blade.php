...
@section('title', 'News Approvals - PCU-DASMA Connect')
@section('page-title', 'News Article Management')

@section('content')
<!-- Header -->
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-900">News Article Management</h1>
    <p class="text-gray-600">Review, approve, and manage news articles submitted by staff members</p>
</div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900">{{ $total_count ?? 28 }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900">{{ $pending_count ?? 5 }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-semibold text-gray-900">{{ $published_count ?? 21 }}</p>
            </div>
        </div>
    </div>
...
<!-- News Articles List -->
<div id="newsCardsContainer" class="space-y-6">
    <!-- News cards will be rendered here -->
</div>

<!-- Modals -->
@include('users.admin.approvals.news._modals.approve-modal')
@include('users.admin.approvals.news._modals.reject-modal')

<script src="{{ asset('js/admin/news-approval.js') }}"></script>
@endsection
