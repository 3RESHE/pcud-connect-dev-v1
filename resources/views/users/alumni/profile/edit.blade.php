        ...
        <form id="profileForm" class="space-y-4 sm:space-y-6 md:space-y-8">
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                ...
                <div class="px-3 sm:px-4 md:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6">
                    ...
                    <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                        <div class="px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-b border-gray-200 bg-gray-50">
                            <h3 class="text-base sm:text-lg font-semibold text-gray-900 break-words">Department Information</h3>
                            <p class="text-xs sm:text-sm text-gray-600 mt-1 break-words">Select the department you graduated from</p>
                        </div>
                        <div class="px-3 sm:px-4 md:px-6 py-4 sm:py-6 space-y-4">

                            <!-- Department Dropdown -->
                            <div class="min-w-0">
                                <label for="department_id" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 break-words">
                                    Department
                                </label>
                                <select id="department_id" name="department_id"
                                    ...
                                    <option value="{{ $dept->id }}" @selected($profile?->department_id === $dept->id)>
                                        {{ $dept->title }}
                                    </option>
                                    @endforeach
                                </select>
                                <p class="text-xs text-gray-500 mt-2 break-words">
                                    ...
                                    <span class="text-green-600 font-medium">✓ Department selected: {{ $profile->getDepartmentName() }}</span>
                                    @else
                                    <span class="text-gray-500">No department selected</span>
                                    @endif
                                </p>
                                <span id="department_idError" class="text-red-500 text-xs mt-1 block break-words hidden"></span>
                            </div>
