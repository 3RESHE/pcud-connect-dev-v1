...
@section('title', 'Edit Partnership Proposal - ' . $partnership->activity_title . ' - PCU-DASMA Connect')
    ...
    <div class="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-4">
                <a href="{{ route('partner.partnerships.show', $partnership->id) }}" class="text-gray-400 hover:text-gray-600 mr-4">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                    </svg>
                </a>
                <h1 class="text-3xl font-bold text-gray-900">
                    Edit Partnership Proposal
                </h1>
            </div>
            <p class="text-gray-600">
                Update your community partnership proposal. Note that you can only edit proposals that are in pending, under review, or rejected status.
            </p>
        </div>

        <!-- Status Warning -->
        @if($partnership->status === 'approved' || $partnership->status === 'completed')
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                <div class="flex items-start">
                    ...
                    <div>
                        <h4 class="font-semibold text-blue-800">Cannot Edit This Proposal</h4>
                        <p class="text-sm text-blue-700">
                            This partnership proposal is {{ ucfirst($partnership->status) }} and cannot be edited. Please contact PCU-DASMA administrators if you need to make changes.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white shadow-sm rounded-lg">
            <form id="partnershipForm" method="POST" action="{{ route('partner.partnerships.update', $partnership->id) }}"
                ...
                <div class="px-6 py-6">
                        ...
                        <div>
                            <label class="relative flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                                <input type="radio" name="activity_type" value="feedingprogram" class="sr-only"
                                    onchange="toggleActivityFields()" @checked($partnership->activity_type === 'feedingprogram')>
                                <div class="flex-1">
                                    <div class="flex items-center">
                                        <div class="activity-type-icon w-8 h-8 bg-orange-100 rounded-lg flex items-center justify-center mr-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500">On-site meals for children & vulnerable groups</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div>
                            <label class="relative flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                                <input type="radio" name="activity_type" value="brigadaeskwela" class="sr-only"
                                    onchange="toggleActivityFields()" @checked($partnership->activity_type === 'brigadaeskwela')>
                                <div class="flex-1">
                                    <div class="flex items-center">
                                        <div class="activity-type-icon w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center mr-3">
                        ...
                        <div>
                            <label class="relative flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                                <input type="radio" name="activity_type" value="communitycleanup" class="sr-only"
                                    onchange="toggleActivityFields()" @checked($partnership->activity_type === 'communitycleanup')>
                                <div class="flex-1">
                                    <div class="flex items-center">
                                        <div class="activity-type-icon w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center mr-3">
                        ...
                        <div>
                            <label class="relative flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                                <input type="radio" name="activity_type" value="treeplanting" class="sr-only"
                                    onchange="toggleActivityFields()" @checked($partnership->activity_type === 'treeplanting')>
                                <div class="flex-1">
                                    <div class="flex items-center">
                                        <div class="activity-type-icon w-8 h-8 bg-emerald-100 rounded-lg flex items-center justify-center mr-3">
                        ...
                        <div>
                            <label class="relative flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                                <input type="radio" name="activity_type" value="donationdrive" class="sr-only"
                                    onchange="toggleActivityFields()" @checked($partnership->activity_type === 'donationdrive')>
                                <div class="flex-1">
                                    <div class="flex items-center">
                                        <div class="activity-type-icon w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center mr-3">
                        ...
                        <div>
                            <label class="relative flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                                <input type="radio" name="activity_type" value="other" class="sr-only"
                                    onchange="toggleActivityFields()" @checked($partnership->activity_type === 'other')>
                                <div class="flex-1">
                                    <div class="flex items-center">
                                        <div class="activity-type-icon w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center mr-3">
                    ...
                    <div id="other_activity_type" class="hidden mt-4">
                        ...
                        <input type="text" id="custom_activity_type" name="custom_activity_type"
                            value="{{ $partnership->custom_activity_type ?? old('custom_activity_type') }}"
                ...
                <div class="px-6 py-6">
                    <h2 class="text-lg font-medium text-gray-900 mb-4">Organization Information</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="organization_name" name="organization_name"
                                value="{{ $partnership->organization_name }}" required
                                class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary"
                        ...
                        <div>
                            ...
                            <input type="url" id="organization_website" name="organization_website"
                                value="{{ $partnership->organization_website }}"
                                class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary"
                    ...
                    <div class="mt-6">
                        ...
                        <textarea id="organization_background" name="organization_background" rows="4" required
                            ...
                            placeholder="Describe your organization, its mission, and experience...">{{ $partnership->organization_background }}</textarea>
                    ...
                    <div class="mt-6">
                        ...
                        <input type="tel" id="organization_phone" name="organization_phone"
                            value="{{ $partnership->organization_phone }}" required
                            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary"
                ...
                <div class="px-6 py-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="activity_title" name="activity_title"
                            value="{{ $partnership->activity_title }}" required
                            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="activity_description" name="activity_description" rows="4" required
                            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary resize-none"
                            placeholder="Describe the activity in detail...">{{ $partnership->activity_description }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="date" id="activity_date" name="activity_date"
                                value="{{ $partnership->activity_date?->format('Y-m-d') }}" required
                                class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">
                            @error('activity_date')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="time" id="activity_time" name="activity_time"
                                value="{{ $partnership->activity_time?->format('H:i') }}" required
                                class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary">
                            @error('activity_time')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="venue_address" name="venue_address" rows="2" required
                            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary resize-none"
                            placeholder="Complete venue address...">{{ $partnership->venue_address }}</textarea>
                        @error('venue_address')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-6">
                        ...
                        <textarea id="activity_objectives" name="activity_objectives" rows="3" required
                            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary resize-none"
                            placeholder="What are the main goals of the activity?">{{ $partnership->activity_objectives }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="expected_impact" name="expected_impact" rows="3" required
                            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary resize-none"
                            placeholder="Describe expected outcome and community impact...">{{ $partnership->expected_impact }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="contact_name" name="contact_name"
                                value="{{ $partnership->contact_name }}" required
                                class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary"
                        ...
                        <div>
                            ...
                            <input type="text" id="contact_position" name="contact_position"
                                value="{{ $partnership->contact_position }}" required
                                class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            <input type="email" id="contact_email" name="contact_email"
                                value="{{ $partnership->contact_email }}" required
                                class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary"
                        ...
                        <div>
                            ...
                            <input type="tel" id="contact_phone" name="contact_phone"
                                value="{{ $partnership->contact_phone }}" required
                                class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary"
                                placeholder="+63 9XX-XXXX-XXXX">
                            @error('contact_phone')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                ...
                <div class="px-6 py-6">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="previous_experience" name="previous_experience" rows="3"
                            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary resize-none"
                            placeholder="Describe any previous partnerships or similar activities...">{{ $partnership->previous_experience }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="additional_notes" name="additional_notes" rows="3"
                            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary resize-none"
                            placeholder="Any other information you'd like to share...">{{ $partnership->additional_notes }}</textarea>
