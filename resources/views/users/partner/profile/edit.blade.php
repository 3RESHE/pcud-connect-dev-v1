        ...
        <div class="mb-6 sm:mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="min-w-0">
                    ...
                    <p class="text-sm sm:text-base text-gray-600 mt-1 break-words">Manage your organization's profile and visibility</p>
                </div>
        ...
        @if (!$profile || is_null($profile->company_name))
            <div class="mb-4 sm:mb-6 bg-amber-50 border-l-4 border-amber-400 p-3 sm:p-4 rounded-r">
                <div class="flex gap-3">
                    ...
                    <p class="text-xs sm:text-sm text-amber-800 break-words"><strong>Important:</strong> Complete your company profile to unlock all partner features.</p>
                </div>
            </div>
        @endif
        ...
        <form id="profileForm" class="space-y-4 sm:space-y-6 md:space-y-8">
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-b border-gray-200 bg-gray-50">
                    ...
                    <p class="text-xs sm:text-sm text-gray-600 mt-1 break-words">Basic information about your organization</p>
                </div>
                <div class="px-3 sm:px-4 md:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6">

                    <!-- Company Logo -->
                    <div>
                        <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-2 sm:mb-3">Company Logo</label>
                        <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6">
                            <div class="flex-shrink-0">
                                @if ($profile && $profile->company_logo)
                                    <img src="{{ asset('storage/' . $profile->company_logo) }}" alt="Company Logo"
                                        class="w-20 h-20 sm:w-24 sm:h-24 rounded-lg object-cover">
                                @else
                                    <div class="w-20 h-20 sm:w-24 sm:h-24 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        <div class="min-w-0">
                            <label for="company_name" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 break-words">
                            ...
                            <span id="company_nameError" class="text-red-500 text-xs mt-1 block break-words hidden"></span>
                        </div>
                        <div class="min-w-0">
                            <label for="industry" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 break-words">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        <div class="min-w-0">
                            <label for="company_size" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 break-words">
                                Company Size
                            </label>
                        ...
                        <div class="min-w-0">
                            <label for="founded_year" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 break-words">
                                Founded Year
                            </label>
                    ...
                    <!-- Company Description -->
                    <div class="min-w-0">
                        <label for="description" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 break-words">
                            Company Description <span class="text-red-500">*</span>
                        </label>
                        <textarea id="description" name="description" rows="4" sm:rows="5" required
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-b border-gray-200 bg-gray-50">
                    ...
                    <p class="text-xs sm:text-sm text-gray-600 mt-1 break-words">How students can reach your organization</p>
                </div>
                <div class="px-3 sm:px-4 md:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        <div class="min-w-0">
                            <label for="contact_person" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 break-words">
                            ...
                            <span id="contact_personError" class="text-red-500 text-xs mt-1 block break-words hidden"></span>
                        </div>
                        <div class="min-w-0">
                            <label for="contact_title" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 break-words">
                                Job Title
                            </label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div class="min-w-0">
                            <label for="website" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 break-words">
                                Company Website
                            </label>
                    ...
                    <!-- Address -->
                    <div class="min-w-0">
                        <label for="address" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2 break-words">
                            Business Address
                        </label>
            ...
            <!-- Action Buttons -->
            <div class="flex flex-col sm:flex-row gap-3 sm:justify-between sm:items-center bg-white shadow-sm rounded-lg p-3 sm:p-4 md:p-6">
                <a href="{{ route('partner.profile.show') }}"
...
<script>
    ...
    function previewLogo(event) {
        ...
        reader.onload = function(e) {
            const preview = document.querySelector('div.w-20.h-20, div.w-24.h-24');
    ...
    function showErrorAlert(message) {
        ...
        document.getElementById('profileForm').parentElement.insertBefore(alertContainer, document.getElementById('profileForm'));
    ...
    document.getElementById('descriptionCount').textContent = document.getElementById('description').value.length + '/2000';
</script>
@endsection
