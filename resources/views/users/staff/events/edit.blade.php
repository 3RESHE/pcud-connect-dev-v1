        ...
        <div class="flex items-start">
            ...
            <div class="ml-4 flex-1">
                <h3 class="text-sm font-semibold text-red-800 mb-3">
                    We found {{ count($errors->all()) }} {{ count($errors->all()) == 1 ? 'error' : 'errors' }} preventing event update:
                </h3>
                <ul class="space-y-2">
    ...
    <form action="{{ route('staff.events.update', $event->id) }}" method="POST" enctype="multipart/form-data" id="eventForm" class="divide-y divide-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        >
                            ...
                            <option value="inperson" {{ old('event_format', $event->event_format) == 'inperson' ? 'selected' : '' }}>In-Person</option>
        ...
        <div class="px-6 py-6">
            ...
            <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="flex items-end">
                        <label class="flex items-center cursor-pointer">
                            ...
                            <input
                                ...
                                {{ old('is_multiday', $event->is_multiday) ? 'checked' : '' }}
                ...
                <!-- End Date -->
                <div id="end_date_field" class="{{ old('is_multiday', $event->is_multiday) ? '' : 'hidden' }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <label class="flex items-center cursor-pointer">
                        ...
                        <input
                            ...
                            name="walkin_allowed"
                            value="1"
                            {{ old('walkin_allowed', $event->walkin_allowed) ? 'checked' : '' }}
                            class="w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary"
                        />
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center cursor-pointer">
                            <input
                                ...
                                value="allstudents"
                                required
                                {{ old('target_audience', $event->target_audience) == 'allstudents' ? 'checked' : '' }}
                        ...
                        <label class="flex items-center cursor-pointer">
                            <input
                                ...
                                value="openforall"
                                required
                                {{ old('target_audience', $event->target_audience) == 'openforall' ? 'checked' : '' }}
                                class="w-4 h-4 border-gray-300 text-primary focus:ring-primary"
                            />
            ...
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <input
                        ...
                        id="event_tags"
                        name="event_tags"
                        value="{{ old('event_tags', $event->event_tags) }}"
                        class="block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
                ...
                <div>
                    ...
                    @if($event->event_image)
                        <div class="mb-4">
                            ...
                            <img id="currentImage" src="{{ asset($event->event_image) }}" alt="Current event banner" class="h-48 w-full object-cover rounded-md border border-gray-200">
                        </div>
                    @endif
                        ...
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-gray-600 justify-center">
                                <label for="event_image" class="relative cursor-pointer font-medium text-primary hover:text-blue-500">
                                    <span>Upload a {{ $event->event_image ? 'new' : '' }} file</span>
        ...
        <div class="px-6 py-6 bg-gray-50">
            <div class="flex flex-col sm:flex-row justify-between gap-3">
                <a href="{{ route('staff.events.show', $event->id) }}" class="px-6 py-2.5 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 font-medium text-center transition-colors duration-200">
                    Cancel
                </a>
...
<script>
    ...
    function toggleRegistrationFields() {
        const show = document.getElementById('registration_required').checked;
