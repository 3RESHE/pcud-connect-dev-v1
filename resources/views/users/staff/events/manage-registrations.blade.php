...
<div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 mb-8">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="flex items-end">
            <a href="{{ route('staff.events.registrations.export', $event->id) }}" class="w-full px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium flex items-center justify-center transition">
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse($registrations as $index => $registration)
                    <tr class="registration-row hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <p class="font-medium text-gray-900">{{ $registration->user->first_name }} {{ $registration->user->last_name }}</p>
                        </td>
                        <td class="px-6 py-4">
