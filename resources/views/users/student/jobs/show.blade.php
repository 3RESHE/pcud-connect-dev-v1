    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6 text-sm text-gray-600">
                        ...
                        <!-- Department -->
                        <div class="flex items-start sm:items-center gap-2 min-w-0 flex-wrap">
                            <svg class="w-5 h-5 flex-shrink-0 text-gray-400" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <span class="truncate">{{ $job->department?->title ?? 'N/A' }}</span>
                            @if($job->department)
            ...
            <div class="space-y-6">
                ...
                <!-- Application Timeline (Only if student already applied) - FULLY UPDATED - ✅ FIXED -->
